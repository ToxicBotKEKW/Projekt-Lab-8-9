...
{
    public partial class DiamondMainPanel : UserControl
    {
        private MineGame mineGame;

        public DiamondMainPanel()
        {
        ...
        {
            this.BackgroundImage = Image.FromFile("../../../Resources/mine-3.jpg");
            this.BackgroundImageLayout = ImageLayout.Stretch;
            this.Click += (s, v) =>
            {
                string result = mineGame.PointForClick(ResourceType.Diamond);
